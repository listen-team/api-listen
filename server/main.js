...
io.on('connection', function(socket){
    ...
    /*ctrlUsuario.convertirTokenUsuario('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ5ZWZyaW9zY2FyOTgxNEBnbWFpbC5jb20iLCJpYXQiOjE0OTkzNzU4NTMsImV4cCI6MTUwMDU4NTQ1M30.zl21HKpqV8XS0WnA5IFW56gTsfF1WAAESGdCJuWMpLk')
    .then(respuesta => {
    ...
    */
    ...
    socket.on('addUser', function(token){
        ...
        /*ctrlUsuario.convertirTokenUsuario(token)
        .then(respuesta => {
            console.log('>>> ' + respuesta.username)
        });*/
        /////////////////////////////////////////////////////////////////////////
